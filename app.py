...
st.write("Transform our files between CSV and Excel formats with built-in data cleaning and visualization!")
...
if uploaded_files:
    for file in uploaded_files:
        ...
        if file_ext == ".csv":
            ...
            continue
        #displat info about file
        st.write(f"File Name: {file.name}")
        st.write(f"File Size: {file.size/1020}")
